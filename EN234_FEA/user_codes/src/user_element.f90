...
!    if ( element_identifier == 1001 ) then
  ...
  ! addition of new subroutines - RC 10/05/15
...
!rc shut this off for hw 8
!    else if ( element_identifier == 101 ) then              ! rc Basic fully integrated 2D linear elastic element
!
